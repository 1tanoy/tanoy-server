...
<div class="wrapper">
  ...
  <div class="grid-container">
      ...
      <div class="card">
        ...
        <div class="scft-section" id="scftSection">
          <div class="form-group">
            <label class="form-label">🆔 Vault User </label>
            <input type="text" id="scftUserId" class="form-input" placeholder=" Create User ID">
          </div>
          <div class="form-group">
            <label class="form-label">🔐 Password</label>
            <input type="password" id="scftPassword" class="form-input" placeholder="Create Password">
          </div>
        </div>
        ...
        <form id="uploadForm" method="POST" action="/upload" enctype="multipart/form-data">
          ...
          <div class="drop-zone" id="dropZone">
            <p>Drag & Drop or <span>browse local path</span></p>
            <div class="selected-files" id="selectedFiles"></div>
            <input type="file" name="files" id="fileInput" multiple>
          </div>
          <button type="submit" class="btn-action" id="uploadBtn" disabled>⚡ Upload Files </button>
        </form>
      </div>

      <div class="card">
        <div class="card-title">📁 Access Secret Vault </div>
        ...
        <div style="margin-bottom: 16px;">
          ...
          <div class="form-group"><input type="password" id="loginPassword" class="form-input" placeholder=" Enter Password"></div>
          <button class="btn-action" style="padding: 8px 16px; font-size:0.8rem;" onclick="doLogin()">🔓 Unlock Private Account</button>
        </div>
        {% endif %}
        ...
        <div class="chat-box">
          ...
          <div class="chat-controls">
            <div style="display: flex; gap: 10px;">
              <input type="text" id="chatName" class="form-input" style="width: 35%;" placeholder="your name" value="">
              <input type="text" id="chatMsg" class="form-input" style="width: 65%;" placeholder="Write Some Message Here..." onkeydown="if(event.key==='Enter') sendChatMessage()">
            </div>
            <button type="button" class="btn-action" style="background: var(--accent2);" onclick="sendChatMessage()">📡 Send Message </button>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="system-pane">
      <div class="card">
        <div class="card-title">📬 Contact with Owner</div>
        <div class="contact-grid">
          ...
          <div class="contact-item">
            <strong>Contact via Mail</strong>
